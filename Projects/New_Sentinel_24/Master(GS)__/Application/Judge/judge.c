	...
	switch(id)
	{
		...
		case ID_game_robot_HP:
			...
			if(judge.data->game_robot_status.robot_id == 7)
			{
				...
				judge.base_info->friendly_base_HP    = (uint8_t)(judge.data->game_robot_HP.red_base_HP/10);
				
				judge.base_info->enemy_outposts_HP = (uint8_t)(judge.data->game_robot_HP.blue_outpost_HP/10);
				judge.base_info->enemy_base_HP     = (uint8_t)(judge.data->game_robot_HP.blue_base_HP/10);
			...
			else if(judge.data->game_robot_status.robot_id == 107)
			{
				...
				judge.base_info->friendly_base_HP    = (uint8_t)(judge.data->game_robot_HP.blue_base_HP/10);
				
				judge.base_info->enemy_outposts_HP = (uint8_t)(judge.data->game_robot_HP.red_outpost_HP/10);
				judge.base_info->enemy_base_HP     = (uint8_t)(judge.data->game_robot_HP.red_base_HP/10);
		...
		case ID_bullet_remaining:
			...
			/*数据处理-----------------------------------------------------------------------------------------*/
			judge.base_info->remain_bullte       = judge.data->bullet_remaining.bullet_remaining_num_17mm/5;
			break;
