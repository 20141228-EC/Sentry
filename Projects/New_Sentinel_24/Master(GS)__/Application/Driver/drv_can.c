...
{
	/*BIG YAW*/
	if (canId == MOTOR_9015_SENT_ID) //9015
	{
	...
	{
		motor_3508_F_structure.info->offline_cnt=0;
		Motor_3508_GetData1(&motor_3508_F_structure);
	}
	else if(canId == 0x202)//3508
	{
		motor_3508_B_structure.info->offline_cnt=0;
		Motor_3508_GetData1(&motor_3508_B_structure);
	}
	/*舵向电机*/
	else if(canId == 0x205)//6020
	{
		servo_6020_F_structure.info->offline_cnt=0;
		Motor_6020_GetData(&servo_6020_F_structure);
	}
 	else if(canId == 0x206)//6020
	{
		servo_6020_B_structure.info->offline_cnt=0;
		Motor_6020_GetData(&servo_6020_B_structure);
	}
	/*Cap*/
