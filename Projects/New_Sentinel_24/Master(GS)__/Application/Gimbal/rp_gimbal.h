...
#define MOROT_9015_MIDDLE (34843)
#define AMMO_1_ANGLE (MOROT_9015_MIDDLE + 8192)
#define AMMO_2_ANGLE (MOROT_9015_MIDDLE - 8192)
#define AMMO_3_ANGLE (MOROT_9015_MIDDLE + 24576)
#define AMMO_4_ANGLE (MOROT_9015_MIDDLE - 24576)
...
//R
#define Y_MOT_UPP_LIMIT       (6820)  //对着左头
#define Y_MOT_LOW_LIMIT       (850)   //对着吕方
// #define Y_MOT_MID_LIMIT       ((Y_MOT_UPP_LIMIT + Y_MOT_LOW_LIMIT)/2) 
#define Y_MOT_MID_LIMIT       (Y_MOT_UPP_LIMIT + 1106)//1106 = (8192 - 6820 + 840)/2

#define P_MOT_UPP_LIMIT       (1580)//头最低
#define P_MOT_LOW_LIMIT       (432)	//头最高
...
#define Y_MOT_LOW_LIMIT_L       (4230)//对着右头
...
#define P_MOT_UPP_LIMIT_L       (4930)//最高
#define P_MOT_LOW_LIMIT_L       (3410)//最低

#define P_Init_L                (4274)
#define Y_Init_L                (5387)
