...
void CAN1_rxDataHandler(uint32_t canId, uint8_t *rxBuf)
{
	...
	{
		servo_6020_LF_structure.info->offline_cnt=0;
		Motor_6020_GetData(&servo_6020_LF_structure);
	}
	else if(canId == 0x206)//6020
	{
		servo_6020_LB_structure.info->offline_cnt=0;
		Motor_6020_GetData(&servo_6020_LB_structure);
	}
	else if(canId == 0x207)//6020
	{
		servo_6020_RB_structure.info->offline_cnt=0;
		Motor_6020_GetData(&servo_6020_RB_structure);
	}
	else if(canId == 0x208)//6020
	{
		servo_6020_RF_structure.info->offline_cnt=0;
		Motor_6020_GetData(&servo_6020_RF_structure);
	}
