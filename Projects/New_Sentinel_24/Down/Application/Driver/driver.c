...
motor_6020_t           servo_6020_LF_structure;
motor_6020_base_info_t servo_6020_LF_base_info;
motor_6020_info_t      servo_6020_LF_info;

motor_6020_t           servo_6020_RF_structure;
motor_6020_base_info_t servo_6020_RF_base_info;
motor_6020_info_t      servo_6020_RF_info;

motor_6020_t           servo_6020_LB_structure;
motor_6020_base_info_t servo_6020_LB_base_info;
motor_6020_info_t      servo_6020_LB_info;

motor_6020_t           servo_6020_RB_structure;
motor_6020_base_info_t servo_6020_RB_base_info;
motor_6020_info_t      servo_6020_RB_info;

/*底盘电机PID*/
pid_t                  chassis_pid_speed_structure[4];
pid_t                  chassis_pid_servo_speed_structure[4];
pid_t                  chassis_pid_servo_position_structure[4];
...
void DEVICE_Init(void)
{
	...
	//My_BMI_Init();  //提醒一下，从SPI转到IIC，需要断电重新上电（烧两次）
