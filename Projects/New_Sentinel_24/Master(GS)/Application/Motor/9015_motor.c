...
void Motor_9015_Init()
{
	...
	// PID_struct_init( &motor_9015_pid_enc_pos,POSITION_PID,P_PIT_LIM_O,P_PIT_LIM_I,0,0,0);
	// PID_struct_init( &motor_9015_pid_enc_spd,POSITION_PID,Y_PIT_LIM_O,Y_PIT_LIM_I,0,0,0);
