...
/*舵向电机6020中值*/
#define SERVO_MIDDLE_FRONT  (4091)
#define SERVO_MIDDLE_BACK   (4781)
...
typedef struct
{
  motor_3508_t *motor_F;       		 /*!< 前轮3508电机初始化
									@ref 在rp_motor_pack中初始化 */

  motor_3508_t *motor_B;      		 /*!< 后轮3508电机初始化
									@ref 在rp_motor_pack中初始化 */

  motor_6020_t *servo_F;       		 /*!< 前轮舵向电机初始化
									@ref 在rp_motor_pack中初始化 */

  motor_6020_t *servo_B;      		 /*!< 后轮舵向电机初始化
									@ref 在rp_motor_pack中初始化 */
...
typedef struct __packed 
{
  int16_t servo_F_angle;   /*!< @ref 前轮舵向输出角度 */
  int16_t servo_B_angle;   /*!< @ref 后轮舵向输出角度 */

  int16_t motor_F_speed;   /*!< @ref 前轮输出速度 */
  int16_t motor_B_speed;   /*!< @ref 后轮输出速度 */
  int16_t servo_F_speed;   /*!< @ref 前轮舵向输出速度 */
  int16_t servo_B_speed;   /*!< @ref 后轮舵向输出速度 */

  int16_t motor_F_current; /*!< @ref 前轮输出电流 */
  int16_t motor_B_current; /*!< @ref 后轮输出电流 */
  int16_t servo_F_current; /*!< @ref 前轮舵向输出电流 */
  int16_t servo_B_current; /*!< @ref 后轮舵向输出电流 */
...
{	
	/*外部电机*/
	motor_3508_t         *motor_F;
	motor_3508_t         *motor_B;
  motor_6020_t         *servo_F;
  motor_6020_t         *servo_B;
