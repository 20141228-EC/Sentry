...
//		gravity_offset = 0;
		...
		gimbal->pid_p_pit->p = K1/*±ÈÀý·Å´ó*/*(log(K2/*Îó²îÃô¸ÐÏµÊý*/ * fabs(gimbal->pid_p_pit->err[0]) + K3/*yÆ«ÒÆ*/));
		if(gimbal->pid_p_pit->p <= K4)
		{
			gimbal->pid_p_pit->p = K4;
		}
	...
	{
		//²âÊÔÓÃ£¬¼ÇµÃÈ¡MOTOR_6020_CAN1_SENT_DATA(motor_6020_PIT_structure.output_current,motor_6020_YAW_structure.output_current,0,0);//×¢ÒâË³Ðò 
		MOTOR_6020_CAN1_SENT_DATA(0,0,0,0);
