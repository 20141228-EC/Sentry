...
ui_interface_string_t* ui_default_Ungroup_NewTextR = &ui_default_Ungroup_2.option;
...
void _ui_init_default_Ungroup_2() {
    ...
    ui_default_Ungroup_2.option.font_size = 20;
    ui_default_Ungroup_2.option.start_x = 200;
    ui_default_Ungroup_2.option.start_y = 325;
    ui_default_Ungroup_2.option.color = 0;
    ui_default_Ungroup_2.option.str_length = 3;
    ui_default_Ungroup_2.option.width = 2;
    strcpy(ui_default_Ungroup_NewTextR->string, "Red");
