...
ui_interface_string_t* ui_default_Ungroup_NewTextg = &ui_default_Ungroup_1.option;
...
void _ui_init_default_Ungroup_1() {
    ...
    ui_default_Ungroup_1.option.font_size = 20;
    ui_default_Ungroup_1.option.start_x = -91;
    ui_default_Ungroup_1.option.start_y = 5;
    ui_default_Ungroup_1.option.color = 2;
    ui_default_Ungroup_1.option.str_length = 1;
    ui_default_Ungroup_1.option.width = 2;
    strcpy(ui_default_Ungroup_NewTextg->string, "G");
