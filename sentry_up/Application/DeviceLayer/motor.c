...
rm_motor_pid_t motor_pid[] = {
	...
	[DIAL] = {
		...
		.speed.kd = 0,
		.speed.integral_max = 8000,
		.speed.out_max = 8000,		//速度环最大输出就是电流值,控制转矩电流范围-10000~10000,对应电机转矩电流-10~10A 
		.angle.kp = 0.15,
		.angle.ki = 0,
		.angle.kd = 0,
